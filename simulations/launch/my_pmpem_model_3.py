...
def setmodelparameters(x=None):
    ...
    opts.changempemparams('Model', 'SIRS') # CHANGED
    ...
    opts.changempemparams('DPCFrequency', 0.1) # CHANGED
    ...
    opts.changempemparams('Rate_0_ItoR', 0.0) # CHANGED
    opts.changempemparams('Rate_0_RtoS', 1000000000) # CHANGED

    # INTENAL DETECTION
    opts.changempemparams('DetectionEnable', 1) # CHANGED
    opts.changempemparams('DetectionParameter', 1.0) # CHANGED
    opts.changempemparams('DetectionFrequency', 1) # CHANGED
    opts.changempemparams('DetectionFirst', 2013.0) # CHANGED
    
    # CONTROL IMPLEMENTATION
    opts.changempemparams('ControlCullEnable', 1) # CHANGED
    opts.changempemparams('ControlCullFrequency', 1.0) # CHANGED
    opts.changempemparams('ControlCullFirst', 2013.01) # CHANGED
    opts.changempemparams('ControlCullLast', 2015.5) # CHANGED
    opts.changempemparams('ControlCullControlMethodSpecification', "RASTER") # CHANGED
    opts.changempemparams('ControlCullControlMethodRasterName', "control_raster.asc") # CHANGED
    opts.changempemparams('ControlCullEffectiveness', x['ControlCullEffectiveness']) # CHANGED
