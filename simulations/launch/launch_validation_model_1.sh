...
-o "../validation/sim_output/model_1/2022_01_31_batch_1_025/" \
--nsamplesperparamset 1000 \
--densityfile "../gen_prior/model_1/validation/grid-tol_applied_only_where_both_bool-0.53_mask_0_025.txt" \
--opertype pd \
--scheduler s \
--slurmqueue "SL2" \
--memoryrequest 6840 \
--parametersfile "params/params_validation_model_1.txt" \
